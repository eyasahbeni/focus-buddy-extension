...
export default function TimeInputRow({ onTimeChange, disabled }) {
  ...
  const InputBox = ({ value, setter, label, name }) => {
  ...
  return (
    <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginBottom: '24px' }}>
      <InputBox value={hours} setter={setHours} label="HH" name="hours" />
      <InputBox value={minutes} setter={setMinutes} label="MM" name="minutes" />
      <InputBox value={seconds} setter={setSeconds} label="SS" name="seconds" />
    </div>
  );
}
